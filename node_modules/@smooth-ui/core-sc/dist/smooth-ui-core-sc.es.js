import { lighten, modularScale, transparentize, darken, mix, parseToRgb, normalize } from 'polished';
import scStyled__default, { css, withTheme } from 'styled-components';
...
var getBreakpointsEntries = function getBreakpointsEntries(props) {
  ...
  var entries = Object.keys(breakpoints).reduce(function (entries, key) {
    return [].concat(entries, [[key, breakpoints[key]]]);
  }, []);
...
var up = function up(name, code) {
  return function (props) {
    ...
    return css(["", "{", ";}"], mediaMinWidth(value), code);
  };
};
var down = function down(name, code) {
  return function (props) {
    ...
    return css(["", "{", ";}"], mediaMaxWidth(value), code);
  };
};
var between = function between(lower, upper, code) {
  return function (props) {
    ...
    if (min !== null && max !== null) {
      return css(["", "{", ";}"], mediaBetweenWidth(min, previousMax), code);
    }
...
th('fontSizeBase', function (fontSize) {
  return modularScale(-1, fontSize);
});
var fontSizeLg =
/*#__PURE__*/
th('fontSizeBase', function (fontSize) {
...
var alertVariant = function alertVariant(p) {
  return function (baseColorTheme) {
    ...
    return {
      ...
      hr: {
        borderTopColor: darken(0.05, mixin('colorLevel', baseColor, alertColorLevel)(p))
      }
    };
  };
}; // Z-indexes
...
var transition = function transition(p) {
  return function (value) {
    return p.theme.transitionEnabled ? css(["transition:", ";@media screen and (prefers-reduced-motion:reduce){transition:none;}"], value) : '';
  };
};
...
var base = function base() {
  return function () {
    return css(["box-sizing:border-box;font-family:", ";font-size:", ";line-height:", ";*{box-sizing:border-box;}"], th('fontFamily'), th('fontSizeBase'), th('lineHeightBase'));
  };
};
var controlFocus = function controlFocus(props) {
  return function (baseColor) {
    ...
    return css(["outline:0;box-shadow:0 0 2px ", ";"], th(baseColor, function (color) {
      return transparentize(0.1, color);
    }));
  };
};
var btnVariant = function btnVariant(props) {
  return function (baseColor) {
    return css(["color:", ";background-color:", ";&:focus{", ";}&:not(:disabled):hover,&:not(:disabled):active{background-color:", ";}"], mixin('colorYik', th(baseColor)), th(baseColor), mixin('controlFocus', baseColor), th(baseColor, function (color) {
...
var composeStyles$1 = function composeStyles() {
  ...
  composedStyle.meta = {
    props: styles.reduce(function (keys, systemStyle) {
      return [].concat(keys, systemStyle.meta.props);
    }, [])
  };
...
createComponent(function () {
  return {
    name: 'alert',
    omitProps: ['variant'],
    style: css(["position:relative;padding:", " ", ";margin-bottom:", ";border:1px solid transparent;border-radius:", ";", ";"], th('alertPaddingY'), th('alertPaddingX'), th('alertMarginBottom'), th('borderRadius'), function (p) {
...
createComponent(function () {
  return {
    name: 'breakpoint',
    omitProps: ['up', 'down'],
    style: css(["display:none;", ";", ";"], function (p) {
...
var sizeStyle = {
  sm:
  /*#__PURE__*/
  css(["padding:", " ", ";font-size:", ";border-radius:", ";line-height:", ";"],
  /*#__PURE__*/
  th('btnPaddingYSm'),
  /*#__PURE__*/
  th('btnPaddingXSm'),
...
var sizeStyle$1 = {
  sm:
  /*#__PURE__*/
  css([".sui-checkbox-content{border-radius:", ";width:0.875rem;height:0.875rem;}.sui-checkbox-check{width:8px;height:8px;}"],
  /*#__PURE__*/
  th('borderRadiusSm')),
  md:
  /*#__PURE__*/
  css([".sui-checkbox-content{border-radius:", ";width:1rem;height:1rem;}.sui-checkbox-check{width:10px;height:10px;}"],
  /*#__PURE__*/
  th('borderRadius')),
  lg:
  /*#__PURE__*/
  css([".sui-checkbox-content{border-radius:", ";width:1.25rem;height:1.25rem;}.sui-checkbox-check{width:12px;height:12px;}"],
  /*#__PURE__*/
  th('borderRadiusLg'))
};
var containerSystem =
...
createComponent(function () {
  return {
    ...
    omitProps: ['valid'],
    style: css(["width:100%;margin-top:0.25rem;font-size:80%;color:", ";"], function (p) {
...
createComponent(function () {
  return {
    name: 'form-check',
    omitProps: ['inline'],
    style: css(["display:flex;align-items:center;", ";"], function (p) {
      return p.inline && css(["display:inline-flex;margin-right:0.75rem;"]);
    }),
    propTypes: {
      children: PropTypes.node,
...
createComponent(function () {
  return {
    ...
    style: css(["padding-left:0.25rem;[class*='disabled'] ~ &{color:", ";}"], th('inputDisabledText')),
    propTypes: {
      children: PropTypes.node
    }
  };
...
var sizeStyle$2 = {
  sm:
  /*#__PURE__*/
  css(["padding:", " ", ";font-size:", ";border-radius:", ";"],
  /*#__PURE__*/
  th('inputPaddingYSm'),
  /*#__PURE__*/
  th('inputPaddingXSm'),
...
var validStyle =
/*#__PURE__*/
css(["border-color:", ";&:focus{border-color:", ";box-shadow:", ";}"],
/*#__PURE__*/
th('success'),
/*#__PURE__*/
th('success'),
...
var controlStyle =
/*#__PURE__*/
css(["display:block;width:100%;&:focus{border-color:", ";box-shadow:", ";}", ";"],
/*#__PURE__*/
...
createComponent(function () {
  return {
    name: 'label',
    defaultComponent: 'label',
    style: css(["display:inline-block;margin-bottom:0.5rem;"]),
    propTypes: {
      children: PropTypes.node
    }
  };
...
createComponent(function () {
  return {
    ...
    style: css(["position:fixed;top:0;right:0;bottom:0;left:0;z-index:", ";visibility:visible;overflow-x:hidden;overflow-y:auto;opacity:0;outline:0;background-color:", ";", ";&.sui-modal-transition-entering{opacity:0;}&.sui-modal-transition-entered{opacity:1;}&.sui-modal-transition-exiting{opacity:0;}"], th('zIndexModal'), th('modalBackdropBg'), mixin('transition', css(["opacity ", "ms ease-in-out"], th('modalTransitionDuration')))),
    propTypes: {
      children: PropTypes.node,
...
createComponent(function () {
  return {
    name: 'modal-body',
    style: css(["position:relative;flex:1 1 auto;padding:", ";"], th('modalInnerPadding')),
    propTypes: {
      children: PropTypes.node
    }
  };
...
createComponent(function () {
  return {
    ...
    style: css(["position:relative;display:flex;flex-direction:column;width:100%;pointer-events:auto;background-color:", ";background-clip:padding-box;border:", " solid ", ";border-radius:", ";box-shadow:", ";outline:0;", ";"], th('modalContentBg'), th('modalContentBorderWidth'), th('modalContentBorderColor'), th('modalContentBorderRadius'), th('modalContentBoxShadowXs'), up('sm', css(["box-shadow:", ";"], th('modalContentBoxShadowSmUp')))),
    propTypes: {
      children: PropTypes.node
    }
  };
...
createComponent(function () {
  return {
    ...
    style: css(["position:relative;width:auto;margin:", ";pointer-events:none;display:flex;align-items:center;min-height:calc( 100% - ", " );", ";"], th('modalDialogMargin'), th('modalDialogMargin', function (value) {
      return calc(value, function (x) {
        return x * 2;
      });
    }), up('sm', css(["max-width:500px;margin:", " auto;min-height:calc( 100% - ", " );"], th('modalDialogMarginYSmUp'), th('modalDialogMarginYSmUp', function (value) {
      return calc(value, function (x) {
        return x * 2;
      });
    })))),
...
createComponent(function () {
  return {
    name: 'modal-footer',
    style: css(["display:flex;align-items:center;justify-content:flex-end;padding:", ";border-top:", " solid ", ";>:not(:first-child){margin-left:0.25rem;}>:not(:last-child){margin-right:0.25rem;}"], th('modalInnerPadding'), th('modalFooterBorderWidth'), th('modalFooterBorderColor')),
    propTypes: {
      children: PropTypes.node
    }
  };
...
createComponent(function () {
  return {
    name: 'modal-header',
    style: css(["display:flex;align-items:flex-start;justify-content:space-between;padding:", ";border-bottom:", " solid ", ";border-top-left-radius:", ";border-top-right-radius:", ";"], th('modalInnerPadding'), th('modalHeaderBorderWidth'), th('modalHeaderBorderColor'), th('modalContentBorderRadius'), th('modalContentBorderRadius')),
    propTypes: {
      children: PropTypes.node
    }
  };
...
var sizeStyle$3 = {
  sm:
  /*#__PURE__*/
  css([".sui-radio-content{width:0.875rem;height:0.875rem;}.sui-radio-circle{width:8px;height:8px;}"]),
  md:
  /*#__PURE__*/
  css([".sui-radio-content{width:1rem;height:1rem;}.sui-radio-circle{width:10px;height:10px;}"]),
  lg:
  /*#__PURE__*/
  css([".sui-radio-content{width:1.25rem;height:1.25rem;}.sui-radio-circle{width:14px;height:14px;}"])
};
...
createComponent(function () {
  return {
    ...
    style: function style$$1(p) {
      var gutter = px(prop('gutter', 'gridGutter')(p));
      return css(["flex-grow:1;flex-wrap:wrap;display:flex;margin-left:-", ";margin-right:-", ";"], gutter, gutter);
    },
    propTypes: {
      children: PropTypes.node,
      gutter: PropTypes.oneOfType([PropTypes.number, PropTypes.string])
...
var sizeStyle$4 = {
  sm:
  /*#__PURE__*/
  css(["select{padding:", " ", ";font-size:", ";border-radius:", ";", ";}.sui-select-arrow{right:0.35rem;width:0.525rem;}"],
  /*#__PURE__*/
  th('inputPaddingYSm'),
  /*#__PURE__*/
  th('inputPaddingXSm'),
  ...
  md:
  /*#__PURE__*/
  css(["select{padding:", " ", ";font-size:", ";", ";border-radius:", ";}.sui-select-arrow{right:0.5rem;width:0.6rem;}"],
  /*#__PURE__*/
  th('inputPaddingY'),
  /*#__PURE__*/
  th('inputPaddingX'),
  ...
  lg:
  /*#__PURE__*/
  css(["select{padding:", " ", ";font-size:", ";border-radius:", ";", ";}.sui-select-arrow{right:0.625rem;width:0.75rem;}"],
  /*#__PURE__*/
  th('inputPaddingYLg'),
  /*#__PURE__*/
  th('inputPaddingXLg'),
...
var validStyle$1 =
/*#__PURE__*/
css(["select{border-color:", ";&:focus{border-color:", ";box-shadow:", ";}}"],
/*#__PURE__*/
th('success'),
/*#__PURE__*/
th('success'),
...
var controlStyle$1 =
/*#__PURE__*/
css(["display:block;width:100%;select{display:block;width:100%;&:focus{border-color:", ";box-shadow:", ";}}", ";"],
/*#__PURE__*/
th('controlFocusBorderColor'),
/*#__PURE__*/
mixin('controlFocusBoxShadow', 'primary'), function (p) {
...
/*#__PURE__*/
css(["margin-top:0;margin-bottom:", ";font-weight:", ";line-height:", ";color:", ";", ";"],
/*#__PURE__*/
...
var variantStyle = {
  h1:
  /*#__PURE__*/
  css(["", ";font-size:", ";"], commonHeadingStyle,
  /*#__PURE__*/
  th('h1FontSize')),
  h2:
  /*#__PURE__*/
  ...
  'display-1':
  /*#__PURE__*/
  css(["", ";font-size:", ";font-weight:", ";line-height:", ";"], commonHeadingStyle,
  /*#__PURE__*/
  th('display1Size'),
  /*#__PURE__*/
  th('display1Weight'),
...
export { theme, styles, Alert, Box, Breakpoint, Button, Checkbox, Col, ControlFeedback, FormCheck, FormCheckLabel, FormGroup, Grid, Input, Label, Modal, ModalBody, ModalContent, ModalContext, ModalCloseButton, ModalDialog, ModalFooter, ModalHeader, Portal, ModalHeader$1 as Radio, RadioGroup, Row, Select, Switch, SwitchState, Textarea, Toggler, Typography, styled, globalStyle, DEFAULT_BREAKPOINTS, getBreakpoints, getBreakpointsEntries, getNextBreakpoint, getPreviousBreakpoint, getBreakpointMin, getBreakpointMax, mediaMinWidth, mediaMaxWidth, mediaBetweenWidth, up, down, between, opacity, overflow, basics, fontFamily$1 as fontFamily, fontSize, lineHeight, fontWeight, textAlign, letterSpacing, color, typography, width, height, maxWidth, maxHeight, minWidth, minHeight, dimensions, space, display, alignItems, alignContent, justifyContent, flexWrap, flexBasis, flexDirection, flex, justifySelf, alignSelf, order, flexboxes, background, backgroundColor, backgroundImage, backgroundSize, backgroundPosition, backgroundRepeat, backgrounds, position, zIndex, top, right, bottom, left, positions, border, borderTop, borderRight, borderBottom, borderLeft, borderColor, borderRadius$1 as borderRadius, boxShadow, borders, system, lazyTh, th, mixin, prop, calc, unit, px, stylePropType, style, composeStyles };
