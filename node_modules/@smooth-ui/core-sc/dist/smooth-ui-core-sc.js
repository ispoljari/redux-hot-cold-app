(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('polished'), require('styled-components'), require('react'), require('prop-types'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'polished', 'styled-components', 'react', 'prop-types', 'react-dom'], factory) :
  (global = global || self, factory(global.smoothUI = {}, global.polished, global.styled, global.React, global.PropTypes, global.ReactDom));
}(this, function (exports, polished, scStyled, React, PropTypes, ReactDOM) { 'use strict';
  ...
  function patchStyledComponent(StyledComponent) {
    ...
    StyledComponent.withComponent = function (component) {
      ...
      var NewTarget = function NewTarget(props) {
        return React__default.createElement(Target, _extends({
          as: component
        }, props));
  ...
  createComponent(function () {
    return {
      ...
      render: function render(_ref2) {
        ...
        return React__default.createElement(Component, {
          className: className
        }, arrow && !props.multiple ? React__default.createElement("svg", {
          ...
          opacity: 0.5,
          d: "M0 0l5 5 5-5"
        }))) : null, React__default.createElement("select", props, children || options.map(function (node) {
          return node.options ? React__default.createElement("optgroup", {
            key: node.label,
            label: node.label
  ...
  var globalStyle = function globalStyle(customTheme) {
    ...
    return [].concat(polished.normalize(), ["\n    html,\n    body {\n      font-family: " + th('fontFamily')({
      theme: customTheme
